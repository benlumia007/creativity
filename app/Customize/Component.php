...
class Component implements Bootable {
    ...
    public function registerPanels( WP_Customize_Manager $manager ) {
		$panels = [
				'theme_global'  => esc_html__( 'Theme: Global',  'creativity' ),
				'theme_header'  => esc_html__( 'Theme: Header',  'creativity' ),
				'theme_content' => esc_html__( 'Theme: Content', 'creativity' ),
				'theme_footer'  => esc_html__( 'Theme: Footer',  'creativity' )
		];
    ...
    public function registerSections( WP_Customize_Manager $manager ) {
		...
		$manager->get_section( 'title_tagline' )->title = esc_html__( 'Branding', 'creativity' );
		...
		$manager->add_section( 'theme_footer_credit', [
			'title' => esc_html__( 'Credit', 'creativity' ),
			'panel' => 'theme_footer'
		] );
